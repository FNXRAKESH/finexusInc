...
const Services = () => {
  return (
    <div id="services" className="mx-lg-5">
          ...
          <div className="col-md-5">
            ...
            <div className="pt-3">
              ...
              <div className="d-flex">
                <h1>
                  We provide Services <br className='d-none d-md-block'/>
                  for{' '}
                  <span className="pe-3">
                    companies to scale!
                  </span>
                  ...
                  <span className="d-flex justify-content-center justify-content-md-start d-none d-md-block">
                    <span className="pe-3">to scale!</span>
          ...
          <div className="col-md-3" id="serviceType">
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="small">
                  We manage the products that are already released
                  and in use by companies or customers.
                </p>
              </div>
            </div>
